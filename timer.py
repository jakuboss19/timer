...
#         self.start_button = tk.Button(master, text="Start", command=self.start, fg="white", bg="black")
#         self.start_button.pack()

#         self.stop_button = tk.Button(master, text="Stop", command=self.stop, fg="white", bg="black")
#         self.stop_button.pack()

#         self.reset_button = tk.Button(master, text="Reset", command=self.reset, fg="white", bg="black")
#         self.reset_button.pack()

#         self.save_button = tk.Button(master, text="Uložit čas", command=self.save_time, fg="white", bg="black")
